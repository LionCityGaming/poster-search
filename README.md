...
A bash script for efficiently searching and organizing poster image files with user-based prioritization and flexible filtering options. This script is designed to work in conjunction with [DAPS (Docker Automated Plex Synchronization)](https://github.com/Drazzilb08/daps) and [DAPS-UI](https://github.com/zarskie/daps-ui/wiki).
